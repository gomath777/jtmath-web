...
const SECTIONS: Section[] = [
  {
    title: '이차방정식과 이차함수',
    pdfName: '이차방정식과 이차함수 레벨3',
    pdfUrl: pdfUrl('03_이차방정식_이차함수', '이차방정식과 이차함수 레벨3.pdf'),
    videos: [
      { num: 1, label: '24년 9월 고1 17번', id: '63a443b5-55f8-4c11-81b7-419874026025' },
      { num: 2, label: '24년 6월 고1 14번', id: '17335197-6036-4a6f-9220-7bb8b335734c' },
      { num: 3, label: '22년 11월 고1 17번', id: 'f3256f16-cfbc-4b2a-bef1-31b06e5b0fcc' },
      { num: 4, label: '22년 9월 고1 16번',  id: 'eed2ae15-56d4-4c8a-9173-c8c86d6750f9' },
      { num: 5, label: '21년 9월 고1 16번',  id: 'efb1f64a-0e8e-4d27-bd28-7402cc576549' },
      { num: 6, label: '20년 6월 고1 27번',  id: 'fdeb07a6-1a7c-4e47-bee3-7f8d146a22b3' },
      { num: 7, label: '20년 6월 고1 14번',  id: '00b6e8e0-0135-4bc7-beb5-43bb4d4b3e15' },
    ],
  },
  {
    title: '여러가지 방정식',
    pdfName: '여러가지 방정식 레벨3',
    pdfUrl: pdfUrl('04_여러가지_방정식_부등식', '여러가지 방정식 레벨3.pdf'),
    videos: [
  ...
  },
  {
    title: '행렬',
    pdfName: '행렬 레벨3',
    pdfUrl: pdfUrl('06_행렬', '행렬 레벨3.pdf'),
    videos: [
...
export default function Gs1Review2Lv3Page() {
  return (
