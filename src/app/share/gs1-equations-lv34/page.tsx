...
const SECTIONS = [
  {
    level: '레벨3',
    pdf: {
      url: 'https://mathgo-pdfs.b-cdn.net/sessions/gs1/04_여러가지방정식/w1s1/여러가지 방정식 레벨3 v2.pdf',
      name: '여러가지 방정식 레벨3',
      size: '2.8 MB',
    },
    videos: [
      ...
      { id: '7f06f805-6708-4c19-9134-a03073caa231', label: '25년 6월 고1 26번',  num: 4 },
      { id: '05f52efc-de32-4c5c-b825-869e9540f958', label: '22년 6월 고1 28번',  num: 5 },
      { id: '1e2ef30b-06b2-4548-88a1-c8f8760afcfa', label: '22년 6월 고1 15번',  num: 8 },
    ],
  },
  {
    level: '레벨4-1',
    pdf: {
      url: 'https://mathgo-pdfs.b-cdn.net/sessions/gs1/04_여러가지방정식/w1s1/여러가지 방정식 레벨4-1 v2.pdf',
      name: '여러가지 방정식 레벨4-1',
      size: '2.3 MB',
    },
    videos: [
      { id: '014cc00f-6f20-44db-8865-51875aaa877d', label: '25년 9월 고1 14번',  num: 1 },
      { id: '5c6cccba-7bba-4002-a806-ce29826edccb', label: '24년 10월 고1 14번', num: 2 },
