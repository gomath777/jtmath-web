...
const PDF_BASE = 'https://mathgo-pdfs.b-cdn.net/sessions/share/ds2-arithseq-lv4-0515';
const PDF_URL = `${PDF_BASE}/${encodeURIComponent('[복습0515]_등차수열_레벨4_인여2.pdf')}`;
...
export default function Ds2ArithSeqLv4Rev2Page() {
  return (
        ...
        <section className="mb-10">
          ...
          >
            ...
            <div className="flex-1 min-w-0">
              <p className="font-medium text-[13px] truncate">[복습0515] 등차수열 레벨4 인여2</p>
              <p className="text-[11px] text-stone mt-0.5">16문항 (원본 8 + 변형 8)</p>
            </div>
