...
const GS2_LESSONS: readonly ConceptLesson[] = [
  ...
  },
  {
    ...
    pdfs: [
      {
        name: '명제의 역과 대우 개념노트',
        url: 'https://mathgo-pdfs.b-cdn.net/concept/gs2/09_%EB%AA%85%EC%A0%9C/2_2_2_%20%EB%AA%85%EC%A0%9C%EC%9D%98%20%EC%97%AD%EA%B3%BC%20%EB%8C%80%EC%9A%B0_v2.pdf',
      },
      {
        name: '충분조건과 필요조건 개념노트',
        url: 'https://mathgo-pdfs.b-cdn.net/concept/gs2/09_%EB%AA%85%EC%A0%9C/2_2_3_%20%EC%B6%A9%EB%B6%84%EC%A1%B0%EA%B1%B4%EA%B3%BC%20%ED%95%84%EC%9A%94%EC%A1%B0%EA%B1%B4_v2.pdf',
      },
    ],
    videos: [
      { num: 13, title: '명제의 역과 대우', id: '3281dad0-05de-4688-9d0d-1dd3f9c76df0' },
      { num: 14, title: '충분조건과 필요조건', id: 'da5a6a18-3013-478a-9f08-48bbcc155bce' },
    ],
  },
  {
    order: 12,
    ...
    pdfs: [
      {
        name: '대우를 이용한 증명법과 귀류법 개념노트',
        url: 'https://mathgo-pdfs.b-cdn.net/concept/gs2/09_%EB%AA%85%EC%A0%9C/2_2_4_%20%EB%8C%80%EC%9A%B0%EB%A5%BC%20%EC%9D%B4%EC%9A%A9%ED%95%9C%20%EC%A6%9D%EB%AA%85%EB%B2%95%EA%B3%BC%20%EA%B7%80%EB%A5%98%EB%B2%95.pdf',
      },
      {
        name: '절대부등식 개념노트',
        url: 'https://mathgo-pdfs.b-cdn.net/concept/gs2/09_%EB%AA%85%EC%A0%9C/2_2_5_%20%EC%A0%88%EB%8C%80%EB%B6%80%EB%93%B1%EC%8B%9D_v2.pdf',
      },
    ],
    videos: [
      { num: 15, title: '대우를 이용한 증명법과 귀류법', id: '28e3a130-3d27-4788-858b-c30af16aad8e' },
      { num: 16, title: '절대부등식', id: '2fe75c54-103a-4b71-a043-01534a1763b2' },
    ],
  },
  {
    order: 13,
    ...
    pdfs: [
      {
        name: '함수의 개념과 그래프 개념노트',
        url: 'https://mathgo-pdfs.b-cdn.net/concept/gs2/10_%ED%95%A8%EC%88%98/3_1_1_%20%ED%95%A8%EC%88%98%EC%9D%98%20%EA%B0%9C%EB%85%90%EA%B3%BC%20%EA%B7%B8%EB%9E%98%ED%94%84_%EB%AC%B8%EC%A0%9C%EC%A7%80_v2.pdf',
      },
    ],
    videos: [
      { num: 17, title: '함수의 개념과 그래프', id: 'd5e870cd-cccc-4a36-9463-842559c0766e' },
    ],
  },
  {
    order: 14,
    ...
    pdfs: [
      {
        name: '함수의 합성 개념노트',
        url: 'https://mathgo-pdfs.b-cdn.net/concept/gs2/10_%ED%95%A8%EC%88%98/3_1_2_%20%ED%95%A8%EC%88%98%EC%9D%98%20%ED%95%A9%EC%84%B1_v2.pdf',
      },
    ],
    videos: [
      { num: 18, title: '함수의 합성', id: '2fd02bb8-7edf-4f6b-b954-fa727a6ecfb2' },
    ],
  },
  {
    order: 15,
    ...
    pdfs: [
      {
        name: '역함수 개념노트',
        url: 'https://mathgo-pdfs.b-cdn.net/concept/gs2/10_%ED%95%A8%EC%88%98/3_1_3_%20%EC%97%AD%ED%95%A8%EC%88%98_v3.pdf',
      },
    ],
    videos: [
      { num: 19, title: '역함수', id: '1cb7fbf0-85ea-4eeb-9aa4-eea376f6711b' },
    ],
  },
  {
    order: 16,
    ...
    pdfs: [
      {
        name: '유리함수의 그래프 개념노트',
        url: 'https://mathgo-pdfs.b-cdn.net/concept/gs2/10_%ED%95%A8%EC%88%98/3_2_1_%20%EC%9C%A0%EB%A6%AC%ED%95%A8%EC%88%98%EC%9D%98%20%EA%B7%B8%EB%9E%98%ED%94%84_v2.pdf',
      },
    ],
    videos: [{ num: 20, title: '유리함수의 그래프', id: '7ca65967-647b-45ca-9e87-3f7a0e977693' }],
  },
  {
    order: 17,
    title: '무리함수',
    pdfs: [
      {
        name: '무리함수의 그래프 개념노트',
        url: 'https://mathgo-pdfs.b-cdn.net/concept/gs2/10_%ED%95%A8%EC%88%98/3_2_2_%20%EB%AC%B4%EB%A6%AC%ED%95%A8%EC%88%98%EC%9D%98%20%EA%B7%B8%EB%9E%98%ED%94%84_v2.pdf',
      },
    ],
    videos: [{ num: 21, title: '무리함수의 그래프', id: '24a01159-33e2-4f3c-8e06-b8313031a8f3' }],
  },
];
const GH_LESSONS: readonly ConceptLesson[] = [
  ...
  },
  {
    ...
    pdfs: [
      {
        name: '구의 방정식 개념노트',
        url: 'https://mathgo-pdfs.b-cdn.net/concept/gh/06_%EA%B3%B5%EA%B0%84%EC%A2%8C%ED%91%9C/2_2_2_%20%EA%B5%AC%EC%9D%98%20%EB%B0%A9%EC%A0%95%EC%8B%9D_v2.pdf',
      },
    ],
    videos: [{ num: 12, title: '구의 방정식', id: 'bc314231-a470-41f0-8cdd-8013bef4af28' }],
  },
  {
    order: 11,
    title: '벡터의 덧셈·뺄셈',
    pdfs: [
      {
        name: '벡터의 덧셈 뺄셈 개념노트',
        url: 'https://mathgo-pdfs.b-cdn.net/concept/gh/07_%EB%B2%A1%ED%84%B0/3_1_1_%20%EB%B2%A1%ED%84%B0%EC%9D%98%20%EB%8D%A7%EC%85%88%20%EB%BA%84%EC%85%88_v3.pdf',
      },
    ],
    videos: [{ num: 13, title: '벡터의 덧셈 뺄셈', id: '659bacf0-203f-4463-aed9-c220e9749c7a' }],
  },
  {
    order: 12,
    title: '벡터의 실수배',
    pdfs: [
      {
        name: '벡터의 실수배 개념노트',
        url: 'https://mathgo-pdfs.b-cdn.net/concept/gh/07_%EB%B2%A1%ED%84%B0/3_1_2_%20%EB%B2%A1%ED%84%B0%EC%9D%98%20%EC%8B%A4%EC%88%98%EB%B0%B0_v2.pdf',
      },
    ],
    videos: [{ num: 14, title: '벡터의 실수배', id: 'd9194f3e-804d-4d4c-918b-14819660c434' }],
  },
  {
    order: 13,
    title: '위치벡터와 벡터의 성분',
    pdfs: [
      {
        name: '위치벡터 개념노트',
        url: 'https://mathgo-pdfs.b-cdn.net/concept/gh/07_%EB%B2%A1%ED%84%B0/3_2_1_%20%EC%9C%84%EC%B9%98%EB%B2%A1%ED%84%B0_v2.pdf',
      },
      {
        name: '벡터의 성분 개념노트',
        url: 'https://mathgo-pdfs.b-cdn.net/concept/gh/07_%EB%B2%A1%ED%84%B0/3_2_2_%20%EB%B2%A1%ED%84%B0%EC%9D%98%20%EC%84%B1%EB%B6%84_v2.pdf',
      },
    ],
    videos: [
      { num: 15, title: '위치벡터', id: 'bb866eac-9ea6-432e-a2f0-53ae678317d7' },
      { num: 16, title: '벡터의 성분', id: '79f773df-2fba-4c8f-a420-d18264043f95' },
    ],
  },
  {
    order: 14,
    ...
    pdfs: [
      {
        name: '벡터의 내적 개념노트',
        url: 'https://mathgo-pdfs.b-cdn.net/concept/gh/07_%EB%B2%A1%ED%84%B0/3_2_3_%20%EB%B2%A1%ED%84%B0%EC%9D%98%20%EB%82%B4%EC%A0%81.pdf',
      },
    ],
    videos: [{ num: 17, title: '벡터의 내적', id: '41300edc-9036-4a80-9cbb-de2286ffb442' }],
  },
  {
    order: 15,
    title: '직선의 방정식',
    pdfs: [
      {
        name: '직선의 방정식 개념노트',
        url: 'https://mathgo-pdfs.b-cdn.net/concept/gh/08_%EC%A7%81%EC%84%A0/3_3_1_%20%EC%A7%81%EC%84%A0%EC%9D%98%20%EB%B0%A9%EC%A0%95%EC%8B%9D_v3.pdf',
      },
    ],
    videos: [{ num: 18, title: '직선의 방정식', id: '8017efae-7d39-4062-ac96-f2ee2ee7b778' }],
  },
  {
    order: 16,
    title: '평면과 구의 방정식',
    pdfs: [
      {
        name: '평면과 구의 방정식 개념노트',
        url: 'https://mathgo-pdfs.b-cdn.net/concept/gh/08_%EC%A7%81%EC%84%A0/3_3_2_%20%ED%8F%89%EB%A9%B4%EA%B3%BC%20%EA%B5%AC%EC%9D%98%20%EB%B0%A9%EC%A0%95%EC%8B%9D_v3.pdf',
      },
    ],
    videos: [{ num: 19, title: '평면과 구의 방정식', id: '3c31c85d-c068-48db-a0f5-72cd8770b912' }],
  },
];
