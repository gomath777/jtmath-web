...
const GH_LEARNING_DATES = [...DEFAULT_LEARNING_DATES, '2026-08-13'] as const;
...
const GH_REVIEW_DATES = new Set(['2026-07-27', '2026-07-28', '2026-08-14']);
...
const GH_LEARNING_DATE_SET = new Set<string>(GH_LEARNING_DATES);
...
function learningDatesFor(subject: SummerSubject): readonly string[] {
  ...
  if (subject === 'gh') return GH_LEARNING_DATES;
...
function learningDateSetFor(subject: SummerSubject): ReadonlySet<string> {
  ...
  if (subject === 'gh') return GH_LEARNING_DATE_SET;
...
function reviewDatesFor(subject: SummerSubject): ReadonlySet<string> {
  ...
  if (subject === 'gh') return GH_REVIEW_DATES;
