...
test('Given a verified guide and a provider timeout When answering a free-form question Then the handler keeps the nearest safe guide stage', async () => {
  ...
  assert.equal(body.meta.provider.failureCategory, 'timeout');
